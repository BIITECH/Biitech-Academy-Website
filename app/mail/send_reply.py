...
class MailSender:
    ...
    def send_confirmation_email(self, recipient_email, recipient_name):
        message = '''<div style="width: 100%; display: flex; height: auto; margin: auto; justify-content: center; align-items: center; background-color: #f0f0f0;">
                        <div style="width: 100%; max-width: 600px; height: 100%; justify-content: center; align-items: center; max-height: 600px; background: #000; border-radius: 10px; margin: 10px auto; padding: 20px;">
                          <div style="justify-content: center; align-items: center; margin: auto; padding: 0 15px;">
                            <h2 style="font-size: 1.8em; font-weight: bold; color: #fff; text-align: center;">Enrollment Success</h2>
                          ...
                          <div style="justify-content: center; align-items: center; margin: auto;">
                            <p style="font-size: 1em; font-weight: 500; color: #fff; text-align: center;">We are pleased to welcome you to our academy. Prepare to embark on an enriching learning journey with us. A representative will be in touch with you shortly.</p>
